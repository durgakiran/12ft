declare module 'jssoup' {
    ...
    type Attributes = string | string[] | { class: string } | { class: string[] } | { [attribute: string]: string };
    ...
    export class SoupTag extends SoupElement {
        ...
        public findPreviousSiblings<T extends SoupElement>(name?: string, attrs?: Attributes, string?: string): T[];
